                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-[#E2E2E240] p-8 rounded-lg shadow-sm">
                        <div className="flex flex-col items-start">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-[#000000]">Direct Pickup & Delivery</h3>
                    ...
                    <div className="bg-[#E2E2E240] p-8 rounded-lg shadow-sm">
                        <div className="flex flex-col items-start">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-[#000000]">End-to-End Logistics</h3>
                                <p className="mt-2 text-[#767676]">
                    ...
                    <div className="bg-[#E2E2E240] p-8 rounded-lg shadow-sm">
                        <div className="flex flex-col items-start">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-[#000000]">Africa-to-the-World Trade Expertise</h3>
                                <p className="mt-2 text-[#767676]">
