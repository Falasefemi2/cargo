...
export default function Header() {
    ...
    return (
        <header className="w-full border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-black z-[50] relative">
                ...
                <div className="flex h-16 items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-6 ml-2">
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {isDropdownOpen && (
                                <div className="absolute left-0 mt-2 w-[900px] rounded-md shadow-lg bg-white dark:bg-black ring-1 ring-black ring-opacity-5 dark:ring-white dark:ring-opacity-10 z-10">
                                    <div className="p-4 grid grid-cols-3 gap-4">
                                        <a href="#" className="block p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <div className="md:hidden ml-auto flex items-center space-x-4">
                        ...
                        <button
                            type="button"
                            className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-black dark:text-gray-500 dark:hover:text-gray-400 dark:hover:bg-gray-800"
